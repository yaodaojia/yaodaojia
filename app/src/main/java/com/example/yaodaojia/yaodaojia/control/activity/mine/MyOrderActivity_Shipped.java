...
public class MyOrderActivity_Shipped extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.my_order_back:
                MyOrderActivity_Shipped.this.finish();
                break;
            default:
                break;
        }

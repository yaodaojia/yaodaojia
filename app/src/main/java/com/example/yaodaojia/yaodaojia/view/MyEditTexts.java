...
public class MyEditTexts extends EditText {
    ...
    public MyEditTexts(Context context) {
        super(context);
        init();
    }

    public MyEditTexts(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MyEditTexts(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        mClearDrawable = getResources().getDrawable(R.drawable.home_search_delete);
    }
